...
public:
    ...
    bool addUrl(const string& url, const vector<string>& anchor_texts, const uint32_t seed_distance, const uint32_t domain_distance, const uint16_t eot, const uint16_t eod, const uint32_t num_encountered);
    bool updateUrl(const string& url, const vector<string>& anchor_texts, const uint32_t seed_distance, const uint32_t domain_distance, const uint32_t num_encountered);
